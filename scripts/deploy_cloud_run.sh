...
echo "--> [1/5] Enabling required Google Cloud APIs (Cloud Run, Firestore, Cloud Tasks, Artifact Registry)..."
...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --set-env-vars="WARDEN_MODE=$WARDEN_RUNTIME_MODE,GOOGLE_CLOUD_PROJECT=$PROJECT_ID" \
    --project="$PROJECT_ID"
